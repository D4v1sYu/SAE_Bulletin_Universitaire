/* Sae Davis Yu 110 le 24/09/2022 | Fix 14/02/2026 */
...
typedef struct {
	unsigned int nbUE; // nombre de coef, commun � toutes les �preuves
	unsigned int nbEtu;
...
// Permet l'ajout d'une epreuve si les conditions sont respect�es (semestre, coefs, non existence)
// [in] Formation
...
void epreuve(Formation* f) {
	...
	else { //Apres toute verification, il ne reste que 2 possibilit�s
...
// [out] Nombre d'UE, Formation initialis�e
...
// Ajout d'une note a l'etudiant si les conditions sont respect�es
// [in-out] Formation
